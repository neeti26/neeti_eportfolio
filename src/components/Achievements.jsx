    ...
    <section id="achievements" style={{ padding: '60px 0' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 10%' }}>
        <div ref={ref} className={`reveal ${visible ? 'visible' : ''}`}>
          ...
          <span className="sec-label">Milestones</span>
          <h2 className="sec-heading">Awards & Achievements.</h2>
            ...
            {achievements.map((item, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontFamily: 'var(--sans)', fontSize: 13, color: 'var(--muted)', lineHeight: 1.4 }}>{item.event}</p>
                </div>
              </div>
            ))}
          </div>
